...
urlpatterns = [
    ...
    path('restaurant/', include('restaurant.urls')), # add urls.py of restaurant with root
    ...
    path('order-confirmation/<int:pk>', OrderConfirmation.as_view(),
         name='order-confirmation'),  # we did passed a parameter in our url here so we used primary key
